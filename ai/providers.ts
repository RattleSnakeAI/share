...
const NVIDIA_AGENT_MODEL_SLUG = "nvidia/nemotron-3-ultra-550b-a55b";
...
const buildProviderMap = (
  ...
  ({
    "ask-model": nvidiaModel(or),
	"ask-model-free": nvidiaModel(or),
	"agent-model": nvidiaModel(or),
	"agent-model-free": nvidiaModel(or),
    ...
    "fallback-agent-model": nvidiaModel(or),
	"fallback-ask-model": nvidiaModel(or),
